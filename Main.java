...
public class Main
{
    ...
    public static void main(String[] args) {
        ...
        if(palabrasABuscar > 0)
        {
            ...
            archivoUno = new TextFile("archivoUno.txt",System.getProperty("user.dir"),1);
            buscadorArchivoUno = new Search(archivoUno, totalPalabras);

            archivoDos = new TextFile("archivoDos.txt",System.getProperty("user.dir"),2);
            buscadorArchivoDos = new Search(archivoDos,totalPalabras);
